<?php
	...
	{
		/**
		 * @var boolean|callable  - how to validate the file.
		 */
		...
		public function run(){
			...
			if (isset($_FILES[$this -> formFileName])){
				...
				if ($this -> validate) {
					...
					new CustomFlash('error','Data','notValidated','Файл не удовлетворяем всем требованиям',true);
				}

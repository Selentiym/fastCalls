 ...
 */
class UserMentor extends UModel
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('name, email, telephone', 'required'),
			array('name, email, skype', 'length', 'max'=>128),
			array('telephone', 'length', 'max'=>20),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, name, email, telephone, skype', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return UserMentor the static model class
	 */
